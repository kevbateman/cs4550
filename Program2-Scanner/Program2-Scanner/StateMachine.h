...
enum MachineState {
	...
	LINECOMMENT_STATE, LBLOCKCOMMENT_STATE, RBLOCKCOMMENT_STATE, VBAR_STATE, AMPERSAND_STATE, OR_STATE, AND_STATE,
	LAST_STATE
};
...
enum CharacterType {
	...
	MINUS_CHAR, PLUS_CHAR, TIMES_CHAR, DIVIDE_CHAR, NOT_CHAR, NEWLINE_CHAR, VBAR_CHAR, AMPERSAND_CHAR,
	LAST_CHAR
};
