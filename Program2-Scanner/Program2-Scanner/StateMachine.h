...
enum MachineState {
	...
	LINECOMMENT_STATE, LBLOCKCOMMENT_STATE, RBLOCKCOMMENT_STATE, VBAR_STATE, AMPERSAND_STATE, OR_STATE, AND_STATE, NOT_STATE, PLUSASSIGNMENT_STATE, MINUSASSIGNMENT_STATE, TIMESASSIGNMENT_STATE,
	LAST_STATE
};
