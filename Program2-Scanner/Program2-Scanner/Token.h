...
enum TokenType {
	...
	BAD_TOKEN, ENDFILE_TOKEN, IF_TOKEN, WHILE_TOKEN, OR_TOKEN, AND_TOKEN, NOT_TOKEN, PLUSASSIGNMENT_TOKEN, MINUSASSIGNMENT_TOKEN, TIMESASSIGNMENT_TOKEN, ENDL_TOKEN
};
...
const std::string gTokenTypeNames[] = {
	...
	"IDENTIFIER", "INTEGER",
	"BAD", "ENDFILE", "IF", "WHILE", "OR", "AND", "NOT", "PLUSASSIGNMENT", "MINUSASSIGNMENT", "ENDL_TOKEN"
};
